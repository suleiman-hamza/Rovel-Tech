        ...
        <div class="hidden md:grid md:grid-cols-3 mt-10 gap-0">
          ...
          >
            <div class="bg-[#057CC3] w-[65%] p-6 text-white text-center">
              <h3 class="text-2xl font-bold mt-4">{{ features[0].title }}</h3>
          ...
          >
            ...
            >
              <h3 class="text-2xl font-bold mt-4">{{ features[1].title }}</h3>
          ...
          >
            ...
            >
              <h3 class="text-2xl font-bold mt-4">{{ features[2].title }}</h3>
              <p class="font-Poppins uppercase">
